...
void WorldState::setVariable(const int var_id, const bool value) { vars_[var_id] = value; }

bool WorldState::getVariable(const int var_id) const { return vars_.at(var_id); }

bool WorldState::operator==(const WorldState &other) const { return (vars_ == other.vars_); }
