...
template <class T>
ObservableLinkedMap<T> ObservableLinkedMap<T>::operator!=(ObservableLinkedMap<T> other)
{
	return map == other;
}
...
template <class T> void ObservableLinkedMap<T>::erase(const UString &id) { removeItem(id); }
...
template <class T> void ObservableLinkedMap<T>::attach(Observer *observer)
{
	observer->attached(this);
	observers.push_back(observer);
}

template <class T> void ObservableLinkedMap<T>::detach(Observer *observer)
{
	observer->detached();
